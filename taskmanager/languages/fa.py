...
translations: Dict[str, str] = {
    ...
    "help_button": "راهنما",
    "help": "🤖 *راهنمای کامل ربات مدیریت وظایف*\n\n*ویژگی‌های اصلی* 🎯\n• **ایجاد و مدیریت تیم‌ها:** ساخت تیم‌های مختلف، تعیین مدیر و عضو، و مدیریت اعضا به صورت پویا.\n• **تعیین و پیگیری وظایف:** تعریف وظیفه برای هر عضو، تعیین توضیحات، مهلت و پیوست فایل یا تصویر.\n• **تغییر وضعیت وظایف:** هر وظیفه می‌تواند وضعیت‌های 'در انتظار'، 'در حال انجام' و 'تکمیل شده' داشته باشد. اعضا و مدیران می‌توانند وضعیت را تغییر دهند.\n• **اعلان‌های هوشمند:** دریافت اعلان هنگام ایجاد، تغییر وضعیت یا حذف وظیفه و یادآوری مهلت سررسید.\n• **مدیریت نقش‌ها:** مدیران می‌توانند اعضا را اضافه/حذف کنند و نقش‌ها را تغییر دهند. اعضا فقط وظایف خود را می‌بینند و به‌روزرسانی می‌کنند.\n• **پشتیبانی چندزبانه:** امکان انتخاب زبان فارسی، انگلیسی و عربی برای هر کاربر.\n\n*دستورات مهم* 📝\n• /add_task - ایجاد وظیفه جدید با امکان تعیین توضیح، مهلت و فایل\n• /add_member - افزودن عضو جدید به تیم با نام کاربری تلگرام\n• /create_team - ساخت تیم جدید و مدیریت اعضا\n• /view_tasks - مشاهده و پیگیری وظایف تیم یا شخصی\n• /help - نمایش این راهنما\n• /menu - منوی اصلی و دسترسی سریع به امکانات\n• /language - تغییر زبان ربات\n\n*نکات تکمیلی:*\n• برای هر سوال یا مشکل از مدیر تیم خود کمک بگیرید یا از /menu استفاده کنید.\n• وضعیت هر وظیفه با ایموجی و متن قابل مشاهده است.\n• امکان ارسال فایل و تصویر برای هر وظیفه وجود دارد.\n• همه اعلان‌ها به صورت خودکار و هوشمند ارسال می‌شوند.",
