...
translations: Dict[str, str] = {
    ...
    "help_button": "دليل",
    "help": "🤖 *دليل شامل لروبوت إدارة المهام*\n\n*الميزات الرئيسية* 🎯\n• **إنشاء وإدارة الفرق:** إنشاء فرق متعددة، تعيين المدراء والأعضاء، وإدارة الأعضاء بسهولة.\n• **تعيين وتتبع المهام:** تعيين المهام لأي عضو، إضافة وصف مفصل، تحديد موعد نهائي، وإرفاق ملفات أو صور.\n• **سير عمل حالة المهمة:** كل مهمة يمكن أن تكون 'قيد الانتظار'، 'قيد التنفيذ' أو 'مكتملة'. يمكن للمدراء والأعضاء تحديث الحالة.\n• **إشعارات ذكية:** استلام إشعارات فورية عند إضافة مهمة جديدة، تغيير الحالة، الحذف، أو تذكير بموعد الاستحقاق.\n• **إدارة الأدوار:** يمكن للمدراء إضافة/إزالة الأعضاء وتغيير الأدوار. الأعضاء يمكنهم فقط رؤية وتحديث مهامهم الخاصة.\n• **دعم متعدد اللغات:** يمكن لكل مستخدم اختيار اللغة المفضلة (العربية، الإنجليزية، الفارسية).\n\n*الأوامر الرئيسية* 📝\n• /add_task - إنشاء مهمة جديدة مع وصف وموعد نهائي وملف\n• /add_member - إضافة عضو جديد للفريق باسم مستخدم تيليجرام\n• /create_team - إنشاء فريق جديد وإدارة الأعضاء\n• /view_tasks - عرض وتتبع مهام الفريق أو المهام الشخصية\n• /help - عرض هذا الدليل\n• /menu - القائمة الرئيسية للوصول السريع\n• /language - تغيير لغة الروبوت\n\n*نصائح إضافية:*\n• لأي سؤال أو مشكلة تواصل مع مدير فريقك أو استخدم /menu.\n• حالات المهام تظهر مع رموز تعبيرية ونصوص لسهولة المتابعة.\n• يمكنك إرفاق ملفات وصور مع أي مهمة.\n• جميع الإشعارات ترسل تلقائياً وبذكاء.",
